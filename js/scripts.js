(function($) {
  ...
  $(window).resize(function() {
    ...
    if (windowWidth <= 974) {
      ...
      $("#gallery-main .flickity-viewport").height(
        $(window).height() - $(".gallery-thumbs").height() - 60
      );
    }
    if (windowWidth > 974) {
  ...
  /* Sidenav
  -------------------------------------------------------*/
  var $navOpened = $(".nav-type-1, .triangle, #nav-icon");
  ...
  function imgFull() {
    ...
    $(".post-fullwidth-img")
      .css("margin-left", "-" + imgOffset / 2 + "px")
      .width(imgFull);
  }
  ...
  function thumbs_height_init() {
    $("#gallery-main .flickity-viewport").height(
      $(window).height() - $(".gallery-thumbs").height()
    );
  }
